 ...
 */
 ...
 insert into librarian_details (id, first_name, last_name) values (librarian_details_sequence.nextval, 'WARREN', 'DSOUZA');
 ...
 insert into librarian_login (id, password) values (librarian_details_sequence.currval, '');
 
 insert into librarian_details (id, first_name, last_name) values (librarian_details_sequence.nextval, 'JIHAN', 'S. PUNIA');
 ...
 insert into librarian_login (id, password) values (librarian_details_sequence.currval, 'iamgay');
 
 insert into librarian_details (id, first_name, last_name) values (librarian_details_sequence.nextval, 'DISHANT', 'DUBEY');
 ...
 insert into librarian_login (id, password) values (librarian_details_sequence.currval, 'proudalien');
